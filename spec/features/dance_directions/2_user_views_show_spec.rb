...
feature 'view dance_directions#show', %{
  ...
  scenario 'sucessfully view a dance_direction#show with optional information' do
  ...
  scenario 'sucessfully view a dance_directions#show from dance_path' do
    ...
    expect(page).to have_current_path(dance_dance_direction_path(dir1.dance_id, dir1.id))
  end
end
